...
namespace GutenbergOne
{
    public class PrintHelper
    {
        ...
        public async Task ShowPrintUIAsync()
        {
            ...
            {
                //jl MainPage.Current.NotifyUser("Error printing: " + e.Message + ", hr=" + e.HResult, NotifyType.ErrorMessage);
            }
        }
            ...
            printTask = e.Request.CreatePrintTask("Essential Grocer Printing Example", sourceRequested =>
            {
                ...
                printTask.Completed += async (s, args) =>
                {
                    ...
                    if (args.Completion == PrintTaskCompletion.Failed)
                    {
                        ...
                        {
                            //jl MainPage.Current.NotifyUser("Failed to print.", NotifyType.ErrorMessage);
                        });
                    }
                };
